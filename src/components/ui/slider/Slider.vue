...
<template>
  ...
  >
    ...
    <SliderThumb
      ...
      :key="key"
      class="block h-5 w-5 rounded-full cursor-pointer disabled:cursor-default border-2 border-primary bg-background ring-offset-background transition-color focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
    />
  </SliderRoot>
</template>
