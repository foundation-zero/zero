...
INSERT INTO loads.variables (id, name, unit, minimum_value, maximum_value) VALUES
    ('a2-lock', 'A2 Lock', 'bool', 0, 1),
    ('a2-overhoist', 'A2 Overhoist', 'bool', 0, 1),
    ('aft-winch-ps-load', 'Aft Winch Ps Load', 'tonne', 0, NULL),
    ('aft-winch-sb-load', 'Aft Winch Sb Load', 'tonne', 0, NULL),
    ('awa', 'Apparent Wind Angle', 'ratio', 0, 180),
    ('aws', 'Apparent Wind Speed', 'ratio', 0, NULL),
    ('blade-adjuster-alarm', 'Blade Adjuster Alarm', 'bool', 0, 1),
    ...
    ('blade-cunningham-alarm', 'Blade Cunningham Alarm', 'bool', 0, 1),
    ...
    ('blade-sheet-captive-ps-position', 'Blade Sheet Captive Ps Position', 'ratio', 0, 1),
    ('blade-sheet-captive-ps-relative-position', 'Blade Sheet Captive Ps Relative Position', 'ratio', 0, 1),
    ('blade-sheet-captive-sb-position', 'Blade Sheet Captive Sb Position', 'ratio', 0, 1),
    ('blade-sheet-captive-sb-relative-position', 'Blade Sheet Captive Sb Relative Position', 'ratio', 0, 1),
    ('blade-sheet-feeder-ps-alarm', 'Blade Sheet Feeder Ps Alarm', 'bool', 0, 1),
    ('blade-sheet-feeder-ps-load', 'Blade Sheet Feeder Ps Load', 'tonne', 0, NULL),
    ('blade-sheet-feeder-sb-alarm', 'Blade Sheet Feeder Sb Alarm', 'bool', 0, 1),
    ('blade-sheet-feeder-sb-load', 'Blade Sheet Feeder Sb Load', 'tonne', 0, NULL),
    ('blade-tweaker-ps-alarm', 'Blade Tweaker Ps Alarm', 'bool', 0, 1),
    ...
    ('blade-tweaker-sb-alarm', 'Blade Tweaker Sb Alarm', 'bool', 0, 1),
    ...
    ('code-sail-tack-load', 'Code Sail Tack Load', 'tonne', 0, NULL),
    ('code-sail-tack-position', 'Code Sail Tack Position', 'ratio', 0, 1),
    ('code-sail-tack-relative-position', 'Code Sail Tack Relative Position', 'ratio', 0, 1),
    ('code-zero-lock', 'Code Zero Lock', 'bool', 0, 1),
    ('code-zero-overhoist', 'Code Zero Overhoist', 'bool', 0, 1),
    ('code-zero-tack-alarm', 'Code Zero Tack Alarm', 'bool', 0, 1),
    ...
    ('headsail-locks-lock-a2', 'Headsail Locks Lock A2', 'bool', 0, 1),
    ('headsail-locks-lock-a3c0', 'Headsail Locks Lock A3/C0', 'bool', 0, 1),
    ('headsail-locks-lock-staysail', 'Headsail Locks Lock Staysail', 'bool', 0, 1),
    ('headsail-locks-lock-stormjib', 'Headsail Locks Lock Storm Jib', 'bool', 0, 1),
    ('headsail-locks-overhoist-a2', 'Headsail Locks Overhoist A2', 'bool', 0, 1),
    ('headsail-locks-overhoist-a3c0', 'Headsail Locks Overhoist A3/C0', 'bool', 0, 1),
    ('headsail-locks-overhoist-staysail', 'Headsail Locks Overhoist Staysail', 'bool', 0, 1),
    ('headsail-locks-overhoist-stormjib', 'Headsail Locks Overhoist Storm Jib', 'bool', 0, 1),
    ...
    ('main-checkstay-deflector-alarm', 'Main Checkstay Deflector Alarm', 'bool', 0, 1),
    ('main-checkstay-deflector-load', 'Main Checkstay Deflector Load', 'tonne', 0, NULL),
    ('main-checkstay-deflector-position', 'Main Checkstay Deflector Position', 'ratio', 0, 1),
    ...
    ('main-cunningham-alarm', 'Main Cunningham Alarm', 'bool', 0, 1),
    ...
    ('main-halyard-alarm', 'Main Halyard Alarm', 'bool', 0, 1),
    ('main-halyard-boom-lock-1', 'Main Halyard Boom Lock 1', 'bool', 0, 1),
    ('main-halyard-boom-lock-2', 'Main Halyard Boom Lock 2', 'bool', 0, 1),
    ('main-halyard-boom-lock-3', 'Main Halyard Boom Lock 3', 'bool', 0, 1),
    ('main-halyard-full-lock', 'Main Halyard Full Lock', 'bool', 0, 1),
    ('main-halyard-full-overhoist', 'Main Halyard Full Overhoist', 'bool', 0, 1),
    ('main-halyard-load', 'Main Halyard Load', 'tonne', 0, NULL),
    ('main-halyard-lock-1', 'Main Halyard Lock 1', 'bool', 0, 1),
    ('main-halyard-lock-2', 'Main Halyard Lock 2', 'bool', 0, 1),
    ('main-halyard-lock-3', 'Main Halyard Lock 3', 'bool', 0, 1),
    ('main-halyard-lock-full', 'Main Halyard Lock Full', 'bool', 0, 1),
    ('main-halyard-overhoist-1', 'Main Halyard Overhoist 1', 'bool', 0, 1),
    ('main-halyard-overhoist-2', 'Main Halyard Overhoist 2', 'bool', 0, 1),
    ('main-halyard-overhoist-3', 'Main Halyard Overhoist 3', 'bool', 0, 1),
    ('main-halyard-overhoist-full', 'Main Halyard Overhoist Full', 'bool', 0, 1),
    ('main-halyard-position', 'Main Halyard Position', 'ratio', 0, 1),
    ...
    ('main-outhaul-alarm', 'Main Outhaul Alarm', 'bool', 0, 1),
    ...
    ('main-preventer-alarm', 'Main Preventer Alarm', 'bool', 0, 1),
    ...
    ('main-runner-ps-alarm', 'Main Runner Ps Alarm', 'bool', 0, 1),
    ('main-runner-ps-load', 'Main Runner Ps Load', 'tonne', 0, NULL),
    ('main-runner-ps-position', 'Main Runner Ps Position', 'ratio', 0, 1),
    ('main-runner-ps-relative-position', 'Main Runner Ps Relative Position', 'ratio', 0, 1),
    ('main-runner-sb-alarm', 'Main Runner Sb Alarm', 'bool', 0, 1),
    ('main-runner-sb-load', 'Main Runner Sb Load', 'tonne', 0, NULL),
    ('main-runner-sb-position', 'Main Runner Sb Position', 'ratio', 0, 1),
    ('main-runner-sb-relative-position', 'Main Runner Sb Relative Position', 'ratio', 0, 1),
    ('main-sheet-alarm', 'Main Sheet Alarm', 'bool', 0, 1),
    ...
    ('main-traveler-position', 'Main Traveler Position', 'ratio', 0, 1),
    ('main-traveler-relative-position', 'Main Traveler Relative Position', 'ratio', 0, 1),
    ('main-vang-alarm', 'Main Vang Alarm', 'bool', 0, 1),
    ('main-vang-load-bottom', 'Main Vang Load Bottom', 'tonne', 0, NULL),
    ('main-vang-load-rod', 'Main Vang Load Rod', 'tonne', 0, NULL),
    ...
    ('mizzen-checkstay-deflector-alarm', 'Mizzen Checkstay Deflector Alarm', 'bool', 0, 1),
    ...
    ('mizzen-cunningham-alarm', 'Mizzen Cunningham Alarm', 'bool', 0, 1),
    ...
    ('mizzen-halyard-alarm', 'Mizzen Halyard Alarm', 'bool', 0, 1),
    ('mizzen-halyard-boom-lock-1', 'Mizzen Halyard Boom Lock 1', 'bool', 0, 1),
    ('mizzen-halyard-boom-lock-2', 'Mizzen Halyard Boom Lock 2', 'bool', 0, 1),
    ('mizzen-halyard-full-lock', 'Mizzen Halyard Full Lock', 'bool', 0, 1),
    ('mizzen-halyard-full-overhoist', 'Mizzen Halyard Full Overhoist', 'bool', 0, 1),
    ('mizzen-halyard-load', 'Mizzen Halyard Load', 'tonne', 0, NULL),
    ('mizzen-halyard-lock-1', 'Mizzen Halyard Lock 1', 'bool', 0, 1),
    ('mizzen-halyard-lock-2', 'Mizzen Halyard Lock 2', 'bool', 0, 1),
    ('mizzen-halyard-lock-3', 'Mizzen Halyard Lock 3', 'bool', 0, 1),
    ('mizzen-halyard-lock-full', 'Mizzen Halyard Lock Full', 'bool', 0, 1),
    ('mizzen-halyard-overhoist-1', 'Mizzen Halyard Overhoist 1', 'bool', 0, 1),
    ('mizzen-halyard-overhoist-2', 'Mizzen Halyard Overhoist 2', 'bool', 0, 1),
    ('mizzen-halyard-overhoist-full', 'Mizzen Halyard Overhoist Full', 'bool', 0, 1),
    ('mizzen-halyard-position', 'Mizzen Halyard Position', 'ratio', 0, 1),
    ('mizzen-halyard-reef-1-lock', 'Mizzen Halyard Reef 1 Lock', 'bool', 0, 1),
    ('mizzen-halyard-reef-1-overhoist', 'Mizzen Halyard Reef 1 Overhoist', 'bool', 0, 1),
    ('mizzen-halyard-reef-2-lock', 'Mizzen Halyard Reef 2 Lock', 'bool', 0, 1),
    ('mizzen-halyard-reef-2-overhoist', 'Mizzen Halyard Reef 2 Overhoist', 'bool', 0, 1),
    ('mizzen-halyard-relative-position', 'Mizzen Halyard Relative Position', 'ratio', 0, 1),
    ('mizzen-headsail-lock', 'Mizzen Headsail Lock', 'bool', 0, 1),
    ('mizzen-headsail-locks-lock', 'Mizzen Headsail Locks Lock', 'bool', 0, 1),
    ('mizzen-headsail-locks-overhoist', 'Mizzen Headsail Locks Overhoist', 'bool', 0, 1),
    ('mizzen-headsail-overhoist', 'Mizzen Headsail Overhoist', 'bool', 0, 1),
    ('mizzen-headsail-tack-adjuster-alarm', 'Mizzen Headsail Tack Adjuster Alarm', 'bool', 0, 1),
    ('mizzen-headsail-tack-adjuster-load', 'Mizzen Headsail Tack Adjuster Load', 'tonne', 0, NULL),
    ('mizzen-headsail-tack-adjuster-position', 'Mizzen Headsail Tack Adjuster Position', 'ratio', 0, 1),
    ('mizzen-headsail-tack-adjuster-relative-position', 'Mizzen Headsail Tack Adjuster Relative Position', 'ratio', 0, 1),
    ('mizzen-outhaul-alarm', 'Mizzen Outhaul Alarm', 'bool', 0, 1),
    ...
    ('mizzen-preventer-alarm', 'Mizzen Preventer Alarm', 'bool', 0, 1),
    ...
    ('mizzen-runner-ps-alarm', 'Mizzen Runner Ps Alarm', 'bool', 0, 1),
    ('mizzen-runner-ps-load', 'Mizzen Runner Ps Load', 'tonne', 0, NULL),
    ('mizzen-runner-ps-position', 'Mizzen Runner Ps Position', 'ratio', 0, 1),
    ('mizzen-runner-ps-relative-position', 'Mizzen Runner Ps Relative Position', 'ratio', 0, 1),
    ('mizzen-runner-sb-alarm', 'Mizzen Runner Sb Alarm', 'bool', 0, 1),
    ('mizzen-runner-sb-load', 'Mizzen Runner Sb Load', 'tonne', 0, NULL),
    ('mizzen-runner-sb-position', 'Mizzen Runner Sb Position', 'ratio', 0, 1),
    ('mizzen-runner-sb-relative-position', 'Mizzen Runner Sb Relative Position', 'ratio', 0, 1),
    ('mizzen-sheet-alarm', 'Mizzen Sheet Alarm', 'bool', 0, 1),
    ('mizzen-sheet-load', 'Mizzen Sheet Load', 'tonne', 0, NULL),
    ('mizzen-sheet-position', 'Mizzen Sheet Position', 'ratio', 0, 1),
    ('mizzen-sheet-relative-position', 'Mizzen Sheet Relative Position', 'ratio', 0, 1),
    ('mizzen-vang-alarm', 'Mizzen Vang Alarm', 'bool', 0, 1),
    ('mizzen-vang-load-bottom', 'Mizzen Vang Load Bottom', 'tonne', 0, NULL),
    ('mizzen-vang-load-rod', 'Mizzen Vang Load Rod', 'tonne', 0, NULL),
    ...
    ('primary-winch-ps-load', 'Primary Winch Ps Load', 'tonne', 0, NULL),
    ('primary-winch-sb-load', 'Primary Winch Sb Load', 'tonne', 0, NULL),
    ('staysail-lock', 'Staysail Lock', 'bool', 0, 1),
    ('staysail-overhoist', 'Staysail Overhoist', 'bool', 0, 1),
    ('staysail-sheet-feeder-ps-alarm', 'Staysail Sheet Feeder Ps Alarm', 'bool', 0, 1),
    ('staysail-sheet-feeder-ps-load', 'Staysail Sheet Feeder Ps Load', 'tonne', 0, NULL),
    ('staysail-sheet-feeder-sb-alarm', 'Staysail Sheet Feeder Sb Alarm', 'bool', 0, 1),
    ('staysail-sheet-feeder-sb-load', 'Staysail Sheet Feeder Sb Load', 'tonne', 0, NULL),
    ('staysail-sheet-ps-position', 'Staysail Sheet Ps Position', 'ratio', 0, 1),
    ('staysail-sheet-ps-relative-position', 'Staysail Sheet Ps Relative Position', 'ratio', 0, 1),
    ('staysail-sheet-sb-position', 'Staysail Sheet Sb Position', 'ratio', 0, 1),
    ('staysail-sheet-sb-relative-position', 'Staysail Sheet Sb Relative Position', 'ratio', 0, 1),
    ('staysail-stay-adjuster-alarm', 'Staysail Stay Adjuster Alarm', 'bool', 0, 1),
