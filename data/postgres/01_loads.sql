...
CREATE TYPE unit AS ENUM ('tonne', 'per-mille', 'on-off');
...
INSERT INTO loads.variables (id, name, unit, minimum_value, maximum_value) VALUES
    ...
    ('main-sheet-position', 'Main Sheet Position', 'per-mille', 0, 1000),
    ('main-traveler-position', 'Main Traveler Position', 'per-mille', 0, 1000),
    ('main-preventer-load', 'Main Preventer Load', 'tonne', 0, NULL),
    ('main-preventer-position', 'Main Preventer Position', 'per-mille', 0, 1000),
    ('main-vang-load', 'Main Vang Load', 'tonne', 0, NULL),
    ('main-vang-position', 'Main Vang Position', 'per-mille', 0, 1000),
    ('main-outhaul-load', 'Main Outhaul Load', 'tonne', 0, NULL),
    ('main-outhaul-position', 'Main Outhaul Position', 'per-mille', 0, 1000),
    ('main-halyard-load', 'Main Halyard Load', 'tonne', 0, NULL),
    ('main-halyard-position', 'Main Halyard Position', 'per-mille', 0, 1000),
    ('main-cunningham-load', 'Main Cunningham Load', 'tonne', 0, NULL),
    ('main-cunningham-position', 'Main Cunningham Position', 'per-mille', 0, 1000),
    ('main-runner-load-ps', 'Main Runner Load Port Side', 'tonne', 0, NULL),
    ('main-runner-position-ps', 'Main Runner Position Port Side', 'per-mille', 0, 1000),
    ('main-runner-load-sb', 'Main Runner Load Starboard Side', 'tonne', 0, NULL),
    ('main-runner-position-sb', 'Main Runner Position Starboard Side', 'per-mille', 0, 1000),
    ...
    ('main-checkstay-position-sb', 'Main Checkstay Position Starboard Side', 'per-mille', 0, 1000),
    ('main-checkstay-deflector-load-ps', 'Main Checkstay Deflector Load Port Side', 'tonne', 0, NULL),
    ('main-checkstay-deflector-position-ps', 'Main Checkstay Deflector Position Port Side', 'per-mille', 0, 1000),
    ('main-checkstay-deflector-load-sb', 'Main Checkstay Deflector Load Starboard Side', 'tonne', 0, NULL),
    ('main-checkstay-deflector-position-sb', 'Main Checkstay Deflector Position Starboard Side', 'per-mille', 0, 1000),
    ...
    ('mizzen-sheet-position', 'Mizzen Sheet Position', 'per-mille', 0, 1000),
    ('mizzen-preventer-load', 'Mizzen Preventer Load', 'tonne', 0, NULL),
    ('mizzen-vang-load', 'Mizzen Vang Load', 'tonne', 0, NULL),
    ('mizzen-vang-position', 'Mizzen Vang Position', 'per-mille', 0, 1000),
    ('mizzen-outhaul-load', 'Mizzen Outhaul Load', 'tonne', 0, NULL),
    ('mizzen-outhaul-position', 'Mizzen Outhaul Position', 'per-mille', 0, 1000),
    ('mizzen-halyard-load', 'Mizzen Halyard Load', 'tonne', 0, NULL),
    ('mizzen-halyard-position', 'Mizzen Halyard Position', 'per-mille', 0, 1000),
    ('mizzen-cunningham-load', 'Mizzen Cunningham Load', 'tonne', 0, NULL),
    ('mizzen-cunningham-position', 'Mizzen Cunningham Position', 'per-mille', 0, 1000),
    ('mizzen-runner-load-ps', 'Mizzen Runner Load Port Side', 'tonne', 0, NULL),
    ('mizzen-runner-position-ps', 'Mizzen Runner Position Port Side', 'per-mille', 0, 1000),
    ('mizzen-runner-load-sb', 'Mizzen Runner Load Starboard Side', 'tonne', 0, NULL),
    ('mizzen-runner-position-sb', 'Mizzen Runner Position Starboard Side', 'per-mille', 0, 1000),
    ('mizzen-checkstay-load-ps', 'Mizzen Checkstay Load Port Side', 'tonne', 0, NULL),
    ('mizzen-checkstay-position-ps', 'Mizzen Checkstay Position Port Side', 'per-mille', 0, 1000),
    ('mizzen-checkstay-load-sb', 'Mizzen Checkstay Load Starboard Side', 'tonne', 0, NULL),
    ('mizzen-checkstay-position-sb', 'Mizzen Checkstay Position Starboard Side', 'per-mille', 0, 1000),
    ('mizzen-checkstay-deflector-load-ps', 'Mizzen Checkstay Deflector Load Port Side', 'tonne', 0, NULL),
    ('mizzen-checkstay-deflector-position-ps', 'Mizzen Checkstay Deflector Position Port Side', 'per-mille', 0, 1000),
    ('mizzen-checkstay-deflector-load-sb', 'Mizzen Checkstay Deflector Load Starboard Side', 'tonne', 0, NULL),
    ('mizzen-checkstay-deflector-position-sb', 'Mizzen Checkstay Deflector Position Starboard Side', 'per-mille', 0, 1000),
