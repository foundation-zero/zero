...
<template>
  ...
  >
    <nav
      role="navigation"
      class="bg-muted border-primary/10 fixed top-0 left-0 h-svh overflow-y-auto border-r py-3 transition-transform max-md:w-full md:min-w-[250px] lg:min-w-[300px]"
