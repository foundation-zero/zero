...
import { DHW_FRESHWATER_CIRCUIT_DATA } from "./connecting-circuits";
...
import { DHW_LEVEL_SWITCHES_DATA } from "./level-switches";
...
export { DHW_FRESHWATER_CIRCUIT_DATA as DHW_HOT_WATER_CIRCUIT_DATA } from "./connecting-circuits";
...
export { DHW_LEVEL_SWITCHES_DATA } from "./level-switches";
...
export const DHW_MIMIC_DATA = toFieldsMap({
  ...
  ...DHW_LEVEL_SWITCHES_DATA,
  ...DHW_ASSET_DATA,
  ...DHW_FRESHWATER_CIRCUIT_DATA,
