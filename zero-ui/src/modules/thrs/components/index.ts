import { THRS, THRSModules } from "@/modules/thrs/lib/consts";
import { fromEntries, isStamped, mapFromObject, toEntries } from "@common/lib/utils";
import { ChartDataType, Entries, Stamped, StampedChart } from "@common/types";
...
>(
  ...
  const historySerializer: Serializer<ComponentHistory> = {
    read: (v) => {
      ...
      return fromEntries(parsed, (_, fields) => new Map(fields));
    },
    write: (v) => {
