<script
  ...
  "
>
import { SIMULATION_FIELDS, THRSModules } from "@/modules/thrs/lib/consts";
import { ExtractSimulationValues, SimulationDefinitions } from "@/modules/thrs/types";
import TimeBasedValueChart from "@common/components/time-based-chart/TimeBasedValueChart.vue";
import { isNumberChart } from "@common/lib/utils";
