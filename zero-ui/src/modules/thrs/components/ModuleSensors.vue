<script
  ...
  "
>
import { SENSOR_FIELDS, THRSModules } from "@/modules/thrs/lib/consts";
import { ExtractSensorValues, SensorDefinitions } from "@/modules/thrs/types";
import { Client } from "@urql/vue";

import TimeBasedCategoryChart from "@common/components/time-based-chart/TimeBasedCategoryChart.vue";
import TimeBasedValueChart from "@common/components/time-based-chart/TimeBasedValueChart.vue";
import { isBooleanChart, isNumberChart } from "@common/lib/utils";
