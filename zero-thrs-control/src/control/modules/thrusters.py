...
states = [
    State(
        name="idle",
        on_exit="_activate_pump",
        on_enter=[
            "_deactivate_pump",
            "_disable_thruster_flow_control",
            "_set_flow_balance_to_idle",
        ],
    ),
    State(
        name="recovery",
