...
class PvtSensorValues(ThrsModel):
    ...
    pvt_temperature_main_fwd_return: Annotated[
        sensor.TemperatureSensor, Meta("50001038-03")
    ]
    pvt_temperature_main_fwd_supply: Annotated[
        sensor.TemperatureSensor, Meta("50001038-23")
    ]
    pvt_temperature_main_aft_return: Annotated[
        sensor.TemperatureSensor, Meta("50001038-73")
    ]
    ...
    # pvt_pressure_owners: Annotated[sensor.PressureSensor, Meta("50001097-05")] # TODO: replace after update FMU
