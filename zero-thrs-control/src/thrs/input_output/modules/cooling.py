...
class CoolingPanelsSensorValues(AmcsModeSensorValues):
    ...
    cooling_mix_main_deckhouse: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006031", component_type="valve", valve_type="mix"),
    ]
    cooling_mix_ps_aft: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006029-1", component_type="valve", valve_type="mix"),
    ]
    cooling_mix_ps_fwd: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006029-3", component_type="valve", valve_type="mix"),
    ]
    cooling_mix_sb_aft: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006029-2", component_type="valve", valve_type="mix"),
    ]
    cooling_mix_sb_fwd: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006029-4", component_type="valve", valve_type="mix"),
    ]
    cooling_switch_california: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-7", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew1: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-18", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew2: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-21", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew3: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-17", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew4: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-20", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew5: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-16", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew6: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-19", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_crew_mess: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-15", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_dutch: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-6", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_french: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-3", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_italian: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-4", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_laundry: Annotated[sensor.Valve, valve_meta(yard_tag="41006011-13")]
    cooling_switch_main_deckhouse: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-8", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_mission_room: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-12", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_owners_deckhouse: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-1", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_owners_ps: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-2", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_owners_sb: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-5", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_polynesian: Annotated[
        sensor.Valve,
        valve_meta(yard_tag="41006011-11", component_type="valve", valve_type="switch"),
    ]
...
class CoolingPanelsControlValues(AmcsWatchdogControlValues):
    ...
    cooling_switch_laundry: Annotated[
        control.Valve,
        valve_meta(yard_tag="41006011-13", component_type="valve", valve_type="switch"),
    ]
    cooling_switch_main_deckhouse: Annotated[
        control.Valve,
        valve_meta(yard_tag="41006011-8", component_type="valve", valve_type="switch"),
    ...
    cooling_pump_sb_aft: Annotated[
        control.Pump, component_meta(yard_tag="41006001-3", component_type="pump")
    ]
    cooling_pump_sb_fwd: Annotated[
