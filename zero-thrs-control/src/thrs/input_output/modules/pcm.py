...
class PcmSensorValues(ThrsModel):
    ...
    pcm_temperature_module_1_out: Annotated[
        sensor.TemperatureSensor, ParameterMeta("50001038-32")
    ]
    pcm_temperature_module_2_out: Annotated[
        sensor.TemperatureSensor, ParameterMeta("50001038-33")
    ]
    pcm_temperature_module_3_out: Annotated[
        sensor.TemperatureSensor, ParameterMeta("50001038-34")
    ]
    pcm_temperature_module_4_out: Annotated[
        sensor.TemperatureSensor, ParameterMeta("50001038-35")
    ]
