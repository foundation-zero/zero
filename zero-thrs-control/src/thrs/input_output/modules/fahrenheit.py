...
class FahrenheitSensorValues(ThrsModel):
    ...
    fahrenheit_flow_hot_exchanger: Annotated[
        sensor.FlowSensor,
        component_meta(yard_tag="50001058-09", component_type="flow sensor"),
    ]
    fahrenheit_flow_hot: Annotated[
        sensor.FlowSensor,
        component_meta(yard_tag="50001058-02", component_type="flow sensor"),
    ]
    fahrenheit_flow_waste: Annotated[
        sensor.FlowSensor,
        component_meta(yard_tag="50001059", component_type="flow sensor"),
    ]
    fahrenheit_flow_cold: Annotated[
        sensor.FlowSensor,
        component_meta(yard_tag="50001058-05", component_type="flow sensor"),
    ]
    fahrenheit_flow_boiler: Annotated[
        sensor.FlowSensor,
        component_meta(yard_tag="50001058-10", component_type="flow sensor"),
    ]
    fahrenheit_temperature_hot_exchanger_return: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-41", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_hot_exchanger_supply: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-50", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_hot_return: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-36", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_hot_supply: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-37", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_waste_return: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-38", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_waste_supply: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-39", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_cold_return: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-42", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_cold_supply: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-43", component_type="temperature sensor"),
    ]
    fahrenheit_temperature_boiler_return: Annotated[
        sensor.TemperatureSensor,
        component_meta(yard_tag="50001038-56", component_type="temperature sensor"),
    ]
